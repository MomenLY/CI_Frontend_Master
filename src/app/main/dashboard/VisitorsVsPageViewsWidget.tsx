 ...
 */
function VisitorsVsPageViewsWidget({booth, billboard}) {
	...
	const widget = {
        ...
        "series": [
            {
                "name": t("dashboard_booth_analytics"),
                "data": booth
            },
            {
                "name": t("dashboard_billboard_analytics"),
                "data": billboard
            }   
        ]
    }
		...
		<Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden h-full">
			<div className="flex items-start justify-between m-24 mb-0">
				<Typography className="text-lg font-medium tracking-tight leading-6 truncate">
					{t('dashboard_billboard_booth_header')}
				</Typography>
				<div className="ml-8">
					{/* <Chip
						size="small"
