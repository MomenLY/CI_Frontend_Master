      ...
      <svg width="100%" height="100%" viewBox="0 0 1366 768">
        ...
        <defs>
          ...
          <clipPath id="leftBanner">
            <path
              d="M 219.599 678.052 L 89.5809 692.322 L 88.6447 284.805 L 217.29 301.974 L 219.599 678.052 Z"
              fill="white"
            />
          </clipPath>
          ...
          <clipPath id="rightBanner">
            <path
              d="M 843.69 678.052 L 973.708 692.322 L 974.644 284.805 L 845.999 301.974 L 843.69 678.052 Z"
              fill="white"
            />
          </clipPath>
        </defs>
        {bannerCenter && (
          <image
            href={`${expoBoothLogoImageUrl(bannerCenter, tenant_id || data?.tenantId)}`}
            x="297.5"
            y="137.5"
            width="388"
            height="137"
        ...
        {bannerLeft && (
          <image
            href={`${expoBoothLogoImageUrl(bannerLeft, tenant_id || data?.tenantId)}`}
            x="88.6447"
            y="284.805"
            width="130.9543"
            height="407.517"
        ...
        {bannerRight && (
          <image
            href={`${expoBoothLogoImageUrl(bannerRight, tenant_id || data?.tenantId)}`}
            x="843.69"
            y="284.805"
            width="130.954"
            height="407.517"
...
export default UserBoothLayout_2;
