      ...
      <svg width="100%" height="100%" viewBox="0 0 1366 768">
        ...
        <defs>
          ...
          <clipPath id="leftBanner">
            <path
              d="M 219.599 678.052 L 89.581 692.322 L 88.6448 284.805 L 217.29 301.974 L 219.599 678.052 Z"
              fill="white"
            />
          </clipPath>
...
export default UserBoothLayout_3;
