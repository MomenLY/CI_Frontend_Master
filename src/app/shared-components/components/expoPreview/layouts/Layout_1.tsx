...
const Layout_1 = ({ json, expo, showEachBooth, setShowEachBooth }) => {
    ...
    <div className="w-full h-full max-h-screen">
      <svg width="100%" height="100%" style={styles.root} viewBox="0 0 1366 768">
        <defs>
          ...
          >
            <image
              href={expoLayoutUrl(`layout_1.webp`)}
              width="1366"
              height="768"
            />
          </pattern>
        ...
        <>
          {json?.booth?.map((boothObj, index) => {
            ...
            // Skip rendering if dimensions or booth data are missing
