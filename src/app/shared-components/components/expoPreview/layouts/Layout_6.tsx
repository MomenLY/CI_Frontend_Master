...
const Layout_6 = ({ json, expo, showEachBooth, setShowEachBooth }) => {
    ...
    const boothDimensions: any = {
        booth_1: { id: 'booth_1', x: 82.143, y: 500.922, width: 288.703, height: 219.048, imageX: 82.143, imageY: 465.585, imageWidth: 167.768, imageHeight: 64.17 },
        booth_2: { id: 'booth_2', x: 1029.3, y: 500.922, width: 288.703, height: 219.048, imageX: 1116.09, imageY: 465.585, imageWidth: 167.77, imageHeight: 64.17 },
        booth_3: { id: 'booth_3', x: 249, y: 424, width: 214, height: 154, imageX: 290.14, imageY: 415.723, imageWidth: 130.773, imageHeight: 50.024 },
        booth_4: { id: 'booth_4', x: 945.087, y: 424, width: 214, height: 154, imageX: 945.087, imageY: 415.723, imageWidth: 130.773, imageHeight: 50.024 },
        booth_5: { id: 'booth_5', x: 425, y: 390, width: 119, height: 89, imageX: 446.298, imageY: 365.344, imageWidth: 88.38, imageHeight: 33.909 },
        booth_6: { id: 'booth_6', x: 831.322, y: 390, width: 119, height: 89, imageX: 831.322, imageY: 365.344, imageWidth: 88.381, imageHeight: 33.909 }
    };
    ...
    return (
        <div style={{ backgroundColor: 'black' }}>
            <svg width="100%" height="100%" style={styles.root} viewBox="0 0 1366 768">
                <defs>
                    <pattern id="bg" patternUnits="userSpaceOnUse" width="1366" height="768">
                        <image href={expoLayoutUrl('layout_6.webp')} width="1366" height="768" />
                    </pattern>
                </defs>
                ...
                <defs>
                    ...
                    <clipPath id="booth_6">
                        <path
                            d="M 919.703 367.4 C 919.734 366.274 918.83 365.344 917.703 365.344 L 833.478 365.347 C 832.378 365.347 831.484 366.236 831.478 367.336 L 831.322 395.299 C 831.316 396.39 832.185 397.285 833.276 397.31 L 916.821 399.253 C 917.922 399.278 918.836 398.41 918.867 397.309 L 919.703 367.4 Z"
                            fill="white"
                        />
                    </clipPath>
                </defs>
                        ...
                        return (
                            <React.Fragment key={boothKey}>
                                <rect
                                    ...
                                    fill="transparent"
                                    onClick={() => handleBoothPress({ layout: expo?.expLayoutId, booth: dimensions.id, data: booth?.data })}
                                />
                                <image
